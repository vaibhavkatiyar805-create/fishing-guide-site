      ...
      <section className="bg-gray-50 py-20">
        <div className="max-w-2xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-700 mb-8">
            If you're interested in booking a trip with us, please reach out to us at the email below.
          </p>
          <a href="mailto:your.email@example.com" className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold py-4 px-8 rounded-lg text-lg transition-colors">
            your.email@example.com
          </a>
          <p className="text-gray-600 mt-6">We'll get back to you within 24 hours</p>
        </div>
      </section>
